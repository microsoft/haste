...
| Preserve local Azurite output routing and surface persistence failures | `backend-dev` | Phase 8 | US-001, US-005 | done — adapter tests and a fresh local queue/container/Azurite/labeling run passed |
