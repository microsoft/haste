...
export default function Visualizer({ setModalComponent }) {
  ...
  // The scene exposes maps only after BOTH panes finish ready/setup.
  // Version changes reuse that scene; keep map readiness separate from
  // the selected version's vector artifact/rendering status shown below.
