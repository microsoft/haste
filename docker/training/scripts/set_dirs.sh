...
export TORCH_HOME=$AZ_BATCH_TASK_WORKING_DIR/
export MPLCONFIGDIR=$AZ_BATCH_TASK_WORKING_DIR/

# Create dirs needed by damage assessment model

mkdir -p $AZ_BATCH_TASK_WORKING_DIR/masks/ $AZ_BATCH_TASK_WORKING_DIR/images/
