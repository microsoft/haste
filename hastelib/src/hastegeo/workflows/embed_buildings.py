...
``workflows.prepare_prediction_tiles`` and reused by the labeler and the
results viewer, so tiling the same geometry again per model produced a
byte-for-byte duplicate archive.
